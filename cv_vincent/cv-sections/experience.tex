...
\begin{cvitems}
\item {Migration of an enterprise system from golang microservices to a Node.js monolith}
\item {Development of a Node.js monolith (TypeScript, Node.js, Fastify, PostgreSQL, Docker)}
