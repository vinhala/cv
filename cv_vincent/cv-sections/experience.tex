...
\item {Backend development of a REST API for the analysis of public procurement data (FastAPI, Python, SQLAlchemy, PostgreSQL)}
\item {Containerization and CI/CD (Docker, github actions)}
\end{cvitems}
}
...
\item {Development of an internal knowledge base and AI Agent (React.js, Next.js, Python, Langchain, OpenSearch, Haystack, Terraform)}
\end{cvitems}
}
